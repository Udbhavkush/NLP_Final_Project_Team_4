...
nlp = sp.load('es_core_news_sm', disable=['parser', 'ner', 'textcat']) if languageName == 'spanish' else sp.load(
...
STOPWORDS_ESP = set(['a', 'ah', 'ahi', 'ahí', 'al', 'algo', 'algunas', 'algunos', 'alli', 'allí', 'ante', 'antes',
                     ...
                     'era', 'erais', 'éramos', 'eramos', 'eran', 'eras', 'eres', 'es', 'esa', 'esas', 'ese', 'eso',
                     'esos',
                     ...
                     'estaras', 'estaré', 'estare', 'estaréis', 'estareis', 'estaría', 'estaria', 'estaríais',
                     'estariais',
                     'estaríamos', 'estariamos', 'estarían', 'estarian', 'estarías', 'estarias', 'estas', 'este',
                     'estemos', 'esto', 'estos', 'estoy', 'estuve', 'estuviera', 'estuvierais', 'estuvieran',
                     'estuvieras',
                     ...
                     'estén', 'esten', 'estés', 'estes', 'f', 'for', 'ft', 'fue', 'fuera', 'fuerais', 'fueran',
                     'fueras',
                     ...
                     'habrás', 'habras', 'habré', 'habre', 'habréis', 'habreis', 'habría', 'habria', 'habríais',
                     'habriais',
                     'habríamos', 'habriamos', 'habrían', 'habrian', 'habrías', 'habrias', 'habéis', 'habeis',
                     'había', 'habia', 'habíais', 'habiais', 'habíamos', 'habiamos', 'habían', 'habian', 'habías',
                     'habias',
                     ...
                     'i', 'j', 'k', 'l', 'lt', 'la', 'las', 'los', 'm', 'más', 'mas', 'mi', 'mis', 'mucho', 'muchos',
                     'muy', 'n', 'nada',
                     'ni', 'o', 'oh', 'otra',
                     ...
                     'sera', 'seran', 'seras', 'sere', 'sereis', 'seria', 'seriais', 'seriamos', 'serian', 'serias',
                     'seais',
                     'siente', 'sin',
                     ...
                     'tengas', 'tengo', 'tengáis', 'tengais', 'tenida', 'tenidas', 'tenido', 'tenidos', 'teniendo',
                     'tenéis', 'teneis',
...
STOPWORDS_ENG = set(
    ['a', 'about', 'above', 'after', 'again', 'against', 'ah', 'ai', 'ain', 'ain"t', 'aint', 'all', 'am',
